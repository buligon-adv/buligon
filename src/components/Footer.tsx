...
export default function Footer() {
  ...
  return (
    <footer className="bg-navy text-white border-t border-white/5">
      {/* Main Footer */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 pt-20 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-8 mb-16">
          ...
          <div className="max-w-xs">
            ...
            <div className="flex gap-4">
               {/* Redes Sociais */}
               <a href={siteConfig.social.whatsapp} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-bronze hover:border-bronze transition-all text-white/50 hover:text-white group">
               ...
               <a href={siteConfig.social.instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-bronze hover:border-bronze transition-all text-white/50 hover:text-white group">
               ...
               <a href={siteConfig.social.linkedin} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-bronze hover:border-bronze transition-all text-white/50 hover:text-white group">
               ...
               <a href={siteConfig.social.facebook} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-bronze hover:border-bronze transition-all text-white/50 hover:text-white group">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-white/5 pt-10 pb-0 flex flex-col md:flex-row justify-between items-center gap-6">
